...
<template>
    <div class="footer bg_header_footer">
        <div class="container">
            <div class="top p-3">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                    ...
                    <div class="col">
                        <div class="aiuto card p-4 border-0 shadow h-100 rounded-0">
                            <h4 class="">Aiuto</h4>
                            <ul>
        ...
        <div class="text-center bg-dark text-white p-5">
            &copy; 2023 Copyright
            <a class="text-white text-decoration-none" href="">Ester Dahri | Licia Licari | Valentina De Mite | Riccardo
                Sansone | Riccardo Voltolina |</a>
        </div>
        <!-- Copyright -->
    </div>
</template>
